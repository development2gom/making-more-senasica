        ...
        <div class="col-xxl-4 col-xl-6 col-lg-6">
          <div id="personalCompletedWidget" class="card card-shadow pb-20">
            <div class="card-header card-header-transparent cover overlay">
              <img class="cover-image" src="<?=Url::base()?>/webAssets/templates/classic/global/photos/placeholder.png">
              <div class="overlay-panel overlay-background vertical-align">
                <div class="vertical-align-middle">
                  <a class="avatar" href="javascript:void(0)">
                    <img alt="" src="<?=Url::base()?>/webAssets/templates/classic/global/portraits/4.jpg">
                  </a>
                ...
                <div data-role="content">
                  <li class="list-group-item">
                    ...
                    <ul class="item-members">
                      <li>
                        <img class="avatar avatar-sm" src="<?=Url::base()?>/webAssets/templates/classic/global/portraits/3.jpg">
                  ...
                  <li class="list-group-item">
                    ...
                    <ul class="item-members">
                      <li>
                        <img class="avatar avatar-sm" src="<?=Url::base()?>/webAssets/templates/classic/global/portraits/1.jpg">
                        <button class="btn btn-sm btn-icon btn-default btn-outline btn-round">
                          <i class="icon wb-pencil" aria-hidden="true"></i>
                        </button>
                      </li>
                      <li>
                        <img class="avatar avatar-sm" src="<?=Url::base()?>/webAssets/templates/classic/global/portraits/5.jpg">
                        <button class="btn btn-sm btn-icon btn-default btn-outline btn-round">
                          <i class="icon wb-pencil" aria-hidden="true"></i>
                        </button>
                      </li>
                  ...
                  <li class="list-group-item">
                    ...
                    <ul class="item-members">
                      <li>
                        <img class="avatar avatar-sm" src="<?=Url::base()?>/webAssets/templates/classic/global/portraits/4.jpg">
                        <button class="btn btn-sm btn-icon btn-default btn-outline btn-round">
                          <i class="icon wb-pencil" aria-hidden="true"></i>
                        </button>
                      </li>
                      <li>
                        <img class="avatar avatar-sm" src="<?=Url::base()?>/webAssets/templates/classic/global/portraits/6.jpg">
                        <button class="btn btn-sm btn-icon btn-default btn-outline btn-round">
                          <i class="icon wb-pencil" aria-hidden="true"></i>
                        </button>
                      </li>
                      <li>
                        <img class="avatar avatar-sm" src="<?=Url::base()?>/webAssets/templates/classic/global/portraits/7.jpg">
                        <button class="btn btn-sm btn-icon btn-default btn-outline btn-round">
                          <i class="icon wb-pencil" aria-hidden="true"></i>
                        </button>
                      </li>
                ...
                <div class="timeline-content-wrap">
                  ...
                  <div class="timeline-content">
                    ...
                    <ul class="members">
                      ...
                      <li>
                        <img class="avatar avatar-sm" src="<?=Url::base()?>/webAssets/templates/classic/global/portraits/8.jpg">
                      </li>
                    </ul>
                  </div>
                </div>
